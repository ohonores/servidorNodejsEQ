angular.module('uiRouterDocElectronicos.menus', [
  'ui.router'
])
  ...
  [          '$stateProvider', '$urlRouterProvider',
    function ($stateProvider,   $urlRouterProvider) {
      $stateProvider
        //////////////
		//	Menu Principal
        // Movimientos y Cliente-Proveedor //
        //////////////
        .state('menu', {
          ...
          // within index.html.
          templateUrl: 'edi-docElectronicos/app/vistas/menu.html',
          ...
          resolve: {
            menusPrincipal: ['menusYestados',
              function( menusYestados){
                return menusYestados.get("menusPrincipal");
              }]
          },

          // You can pair a controller to your template. There *must* be a template to pair with.
          controller: ['$scope', '$state', 'menusYestados', 'utils',
            function (  $scope,   $state,   menusYestados,   utils) {

              // Add a 'contacts' field in this abstract parent's scope, so that all
              // child state views can access it in their scopes. Please note: scope
              // inheritance is not due to nesting of states, but rather choosing to
              // nest the templates of those states. It's normal scope inheritance.
              $scope.menus = menusPrincipal;
        ...
        .state('menu.submenu-conf', {
          ...
          templateUrl: 'edi-docElectronicos/app/vistas/submenu-conf.html'
        })
        ...
        .state('menu.detalle', {
          ...
          views: {
            ...
            '': {
              templateUrl: 'edi-docElectronicos/app/vistas/menuDetalle.html',
              controller: ['$scope', '$stateParams', 'utils',
                function (  $scope,   $stateParams,   utils) {
                  $scope.menuDetalle = utils.findById($scope.menus, $stateParams.menuId);
                }]
            },
            ...
            'menuTip': {
              ...
              templateProvider: ['$stateParams',
                function (        $stateParams) {
                  ...
                  return '<hr><small class="muted">Contact ID: ' + $stateParams.menus + '</small>';
                }]
            }
          }
        })
